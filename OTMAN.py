...
def ArA_CoLor():
    Tp = [   
        "FF9999", "99FF99", "99CCFF", "FFD700", "FFB6C1", 
        "FFA07A", "98FB98", "E6E6FA", "AFEEEE", "F0E68C", 
        "FFE4B5", "D8BFD8", "FFFACD", "87CEFA", "FFDEAD", 
        "B0E0E6", "FFDAB9", "E0FFFF", "F5DEB3", "FFC0CB", 
        "FFF0F5", "ADD8E6"]
    return random.choice(Tp)
    
def MsqSq(Msg, id, K, V):
    fields = {1: id, 2: id, 4: Msg, 5: 1756580149, 7: 2, 8: 901048018, 
              9: {1: "OTMAN_BOT", 2: xBunnEr(), 4: 330, 5: 827001005, 8: "OTMAN_BOT", 
                  10: 1, 11: 1, 13: {1: 2}, 14: {1: 1158053040, 2: 8, 
                  3: "\u0010\u0015\b\n\u000b\u0015\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"}}, 
              10: "en", 13: {2: 2, 3: 1}}
...
def xSEndMsg(Msg, Tp, Tp2, id, K, V):
    fields = {1: id, 2: Tp2, 3: Tp, 4: Msg, 5: 1735129800, 7: 2, 
              9: {1: "OTMAN_BOT", 2: int(xBunnEr()), 3: 901048018, 4: 330, 5: 909034009, 
                  8: "OTMAN_BOT", 10: 1, 11: 1, 13: {1: 2}, 
